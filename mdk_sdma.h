...
/*****************************************************************************
 函 数 名  : sdma_free_chn
 功能描述  : 释放sdma独占通道
 输入参数  : phandle--sdma通道句柄，由sdma_alloc_chn接口返回
 输出参数  : 无
 返 回 值  : 0--释放通道成功
	     其他错误码--释放通道失败
****************************************************************************/
...
/*****************************************************************************
 ...
 功能描述  : 释放sdma共享通道
 输入参数  : phandle--sdma通道句柄，由sdma_init_chn接口返回
 输出参数  : 无
 返 回 值  : 0--释放通道成功
	     其他错误码--释放通道失败
****************************************************************************/
...
/*****************************************************************************
 ...
 功能描述  : sdma下发count个拷贝任务至独占通道
 输入参数  : phandle--sdma通道句柄
	     sdma_sqe--sqe数据指针
	     count--下发任务数量
 输出参数  : 无
 返 回 值  : 0--下发任务成功
...
/*****************************************************************************
 ...
 功能描述  : sdma下发count个拷贝任务至共享通道
 输入参数  : phandle--sdma通道句柄
	     sdma_sqe--sqe数据指针
	     count--下发任务数量
 输出参数  : request--sdma拷贝数据请求指针，用于sdma_iwait_chn接口输入
 返 回 值  : 0--下发任务成功
	     其他错误码--下发任务失败
****************************************************************************/
...
/*****************************************************************************
 ...
 功能描述  : 查询sdma共享通道是否完成指定请求任务
 输入参数  : phandle--sdma通道句柄
	     request--sdma拷贝请求指针，由sdma_icopy_data接口返回
 输出参数  : 无
 返 回 值  : 0--拷贝数据完成
	     其他错误码--拷贝数据未完成
****************************************************************************/
...
/*****************************************************************************
 ...
 输入参数  : fd--sdma文件句柄
	     vma--虚拟地址
	     size--PIN内存大小
 输出参数  : cookie--用于标识pin住的页表，用于sdma_unpin_umem输入
 返 回 值  : 0--pin页表操作成功
	     其他错误码--pin页表操作失败
****************************************************************************/
